...
metadata and present in the BLAKE3 object store. v1.1.1 does not automatically
...
Yes. In v1.1.1, open Recovery Home's Storage page and select an empty folder such
...
in v1.1.1 is planning/dry-run only, so it never removes history automatically.
