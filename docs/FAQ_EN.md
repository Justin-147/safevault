...
metadata and present in the BLAKE3 object store. v1.1.7 does not automatically
...
in v1.1.7 is planning/dry-run only, so it never removes history automatically.
